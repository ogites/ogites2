        ...
        <div class="container">
            ...
            ?>
                    <table class="table table-striped table-primary">
                        <thead>
                            <tr>
                                <th>
                                    <h3>
                                        <center>Les informations sur vous :
                    ...
                    <h5>
                        ...
                        <br><br>
                        <i class="fa fa-user"></i> <strong>Prenom :</strong><br>
                        <?php echo ucfirst($_SESSION["prenom"]); ?>
                        <br><br>
                        <i class="fa fa-envelope"></i> <strong>Adresse mail :</strong>
